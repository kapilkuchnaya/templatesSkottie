...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"009fb872ef6e593b70b3a3e1d2dd02a82287c7f66b":"logout","40a242b78bf3c308840471631b905412891b158634":"deleteTemplate","6059cd153796468d4bad3be1f043ef279fceec49c0":"toggleTemplateMultiStatus","605ebdba1a157410461afe12ff28c7292394bb03d6":"toggleTemplateProStatus","60922b336b8354a99e49216e2c19945e6c44dbe7c1":"authenticate","60cbb3701b3d531f83a4757a0a2a05ce853bb511fe":"uploadTemplate"},"",""] */ __turbopack_context__.s({
...
async function uploadTemplate(prevState, formData) {
    ...
    try {
        const newTemplateContent = await file.text();
        const newTemplate = JSON.parse(newTemplateContent);
        if (!newTemplate.category || !Array.isArray(newTemplate.category) || newTemplate.category.length === 0) {
            return {
                error: "Template JSON must have a 'category' array with at least one category."
            };
        }
        ...
        const templates = await readTemplatesFromFile();
...
async function readTemplatesFromFile() {
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'src', 'lib', 'data', 'templates.json');
    try {
...
async function writeTemplatesToFile(templates) {
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'src', 'lib', 'data', 'templates.json');
...
async function toggleTemplateProStatus(originalId, currentStatus) {
    try {
        const templatesByCat = await readTemplatesFromFile();
        let found = false;
        ...
        await writeTemplatesToFile(templatesByCat);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])("/admin");
        return {
    ...
    try {
        ...
        for(const category in templatesByCat){
            ...
            if (templatesByCat[category].length < initialLength) {
                ...
                // If a category becomes empty, you might want to remove it
...
async function getTemplates() {
    ...
    try {
        ...
        if (typeof data !== 'object' || data === null || Array.isArray(data)) {
            console.error("Error: templates.json is not a category-grouped object.");
            return [];
        }
        const allTemplates = Object.values(data).flat();
        // Assign originalId for easier editing/deleting
        return allTemplates;
    } catch (error) {
        console.error("Error reading or parsing templates.json:", error);
        if (error.code === 'ENOENT') {
            console.log('templates.json not found. Returning empty array.');
            return [];
        }
        console.error("Parsing error in templates.json:", error);
        return [];
    }
}
}}),
...
"[project]/src/components/templates/upload-template.tsx (client reference/proxy) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2d$edge$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/rsc/react-server-dom-turbopack-server-edge.js [app-rsc] (ecmascript)");
;
const UploadTemplate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2d$edge$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call UploadTemplate() from the server but UploadTemplate is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/templates/upload-template.tsx <module evaluation>", "UploadTemplate");
}}),
"[project]/src/components/templates/upload-template.tsx (client reference/proxy)": ((__turbopack_context__) => {
"use strict";
...
const UploadTemplate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2d$edge$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call UploadTemplate() from the server but UploadTemplate is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/components/templates/upload-template.tsx", "UploadTemplate");
}}),
"[project]/src/components/templates/upload-template.tsx [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$templates$2f$upload$2d$template$2e$tsx__$28$client__reference$2f$proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/components/templates/upload-template.tsx (client reference/proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$templates$2f$upload$2d$template$2e$tsx__$28$client__reference$2f$proxy$29$__ = __turbopack_context__.i("[project]/src/components/templates/upload-template.tsx (client reference/proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$templates$2f$upload$2d$template$2e$tsx__$28$client__reference$2f$proxy$29$__);
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$templates$2f$upload$2d$template$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/templates/upload-template.tsx [app-rsc] (ecmascript)");
...
function Header() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: "sticky top-0 z-30 flex h-16 items-center gap-4 border-b bg-background/95 backdrop-blur-sm px-4 md:px-6",
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$templates$2f$upload$2d$template$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["UploadTemplate"], {}, void 0, false, {
                            fileName: "[project]/src/components/header.tsx",
                            lineNumber: 19,
                            columnNumber: 11
                        }, this),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8a449b8._.js.map