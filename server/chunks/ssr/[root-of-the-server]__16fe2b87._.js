...
function TemplateGrid({ templates: initialTemplates, onTemplatesChange, db }) {
...
"[project]/src/lib/data-client.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
// This file is for client-side data fetching.
// It's a placeholder for if you were to fetch from an API endpoint.
// For now, it simulates a fetch.
__turbopack_context__.s({
    "getTemplates": (()=>getTemplates),
    "getTemplatesDb": (()=>getTemplatesDb),
    "getTemplatesDbNew": (()=>getTemplatesDbNew)
});
async function fetchTemplates(db) {
    // In a real app, you'd fetch from an API route.
    // For example: const response = await fetch(`/api/templates?db=${db}`);
    // For this project, we're importing the server-side data fetching functions
    // which is NOT standard practice but works for this self-contained demo.
    try {
        const { getTemplates: s_getTemplates, getTemplatesDb: s_getTemplatesDb, getTemplatesDbNew: s_getTemplatesDbNew } = await __turbopack_context__.r("[project]/src/lib/data.ts [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        const fetcher = {
            'main': s_getTemplates,
            'db': s_getTemplatesDb,
            'db-new': s_getTemplatesDbNew
        }[db];
        return await fetcher();
    } catch (e) {
        console.error("Failed to fetch templates on the client:", e);
        return [];
    }
}
async function getTemplates() {
    return fetchTemplates('main');
}
async function getTemplatesDb() {
    return fetchTemplates('db');
}
async function getTemplatesDbNew() {
    return fetchTemplates('db-new');
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/data-client.ts [app-ssr] (ecmascript)");
...
;
;
function TemplateGridWrapper({ db }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function fetchTemplates() {
            setIsLoading(true);
            const dataFetchers = {
                'main': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTemplates"],
                'db': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTemplatesDb"],
                'db-new': __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTemplatesDbNew"]
            };
            const fetchedTemplates = await dataFetchers[db]();
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(TemplateGridWrapper, {
                        db: db
                    }, void 0, false, {
                        fileName: "[project]/src/components/templates/template-grid-page.tsx",
                        lineNumber: 73,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16fe2b87._.js.map