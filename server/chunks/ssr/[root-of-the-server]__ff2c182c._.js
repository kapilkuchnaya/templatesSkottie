...
async function uploadTemplate(prevState, formData) {
    ...
    try {
        // Sanitize and attempt to fix common JSON pasting issues.
        let sanitizedContent = newTemplateContent.trim();
        if (sanitizedContent.startsWith("{") && sanitizedContent.endsWith("}")) {
            // If it looks like multiple objects, wrap in an array.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ff2c182c._.js.map