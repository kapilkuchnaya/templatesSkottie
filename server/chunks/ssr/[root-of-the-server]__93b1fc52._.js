...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ [{"009fb872ef6e593b70b3a3e1d2dd02a82287c7f66b":"logout","400c23683a4388243db1212c4219d6919d16a47721":"deleteTemplateDb","40a242b78bf3c308840471631b905412891b158634":"deleteTemplate","603adedf048c24623454e943645362eddde2f135ee":"uploadTemplateDb","6059cd153796468d4bad3be1f043ef279fceec49c0":"toggleTemplateMultiStatus","605ebdba1a157410461afe12ff28c7292394bb03d6":"toggleTemplateProStatus","6074138201d2fd2df7a178250d8044fa432a8ffa5d":"toggleTemplateMultiStatusDb","60922b336b8354a99e49216e2c19945e6c44dbe7c1":"authenticate","6097edc0931a576ff840ad641a0eb2933653aa7d38":"toggleTemplateProStatusDb","60cbb3701b3d531f83a4757a0a2a05ce853bb511fe":"uploadTemplate"},"",""] */ __turbopack_context__.s({
...
async function readTemplatesFromFile(fileName) {
...
async function writeTemplatesToFile(fileName, templates) {
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'src', 'lib', 'data', fileName);
...
// --- Base Action Logic ---
async function uploadTemplateBase(dbFile, prevState, formData) {
...
async function toggleTemplateProStatusBase(dbFile, originalId, currentStatus, revalidationPath) {
    try {
...
async function toggleTemplateMultiStatusBase(dbFile, originalId, currentStatus, revalidationPath) {
    try {
        const templatesByCat = await readTemplatesFromFile(dbFile);
        let found = false;
        for(const category in templatesByCat){
...
async function deleteTemplateBase(dbFile, originalId, revalidationPath) {
    try {
        const templatesByCat = await readTemplatesFromFile(dbFile);
...
;
;
async function getTemplatesFromFile(fileName) {
    const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'src', 'lib', 'data', fileName);
    try {
        ...
        if (error.code === 'ENOENT') {
            ...
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].promises.writeFile(filePath, '{}', 'utf-8');
            return [];
        }
...
;
;
function TemplateGridPage({ title, templates, categories, formats, db }) {
...
async function TemplatesDbPage() {
    const templates = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getTemplatesDb"])();
    const allCategories = [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__93b1fc52._.js.map